...
const Header = ({ setActiveTab, isMobile, onOpenMobileNav }) => {
    ...
    return (
        ...
        <header
            ...
            {/* Real mobile hamburger toggle - only rendered on mobile, so
                the desktop header's own left section is completely
                unchanged below. Opens the real, off-canvas drawer built
                in sidebar.jsx/DashboardLayout.jsx. */}
            {isMobile && (
                <button
