...
import { Utensils, Flame, Droplet, Apple, Target, User, Plus, Calendar, Activity, CheckCircle, TrendingUp, Award, Search, Layers, Check, Trash2, Clock, Sparkles, ShoppingCart, Package, Cpu } from 'lucide-react';
                        ...
                        <form onSubmit={handleAddMeal} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            <div style={{ display: 'flex', gap: '12px' }}>
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Meal Type</label>
                                    <select value={newMeal.title} onChange={(e) => setNewMeal({...newMeal, title: e.target.value})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', outline: 'none' }}>
                                ...
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Time</label>
                                    <input type="text" placeholder="e.g. 08:30 AM" value={newMeal.time} onChange={(e) => setNewMeal({...newMeal, time: e.target.value})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', outline: 'none' }} />
                                </div>
                            </div>
                            <div>
                                <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Food Name / Details</label>
                                <input type="text" required placeholder="e.g. Oats + Eggs" value={newMeal.foodName} onChange={(e) => setNewMeal({...newMeal, foodName: e.target.value})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', outline: 'none' }} />
                            </div>
                            <div style={{ display: 'flex', gap: '12px' }}>
                                <div style={{ flex: 1, minWidth: 0 }}><label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Calories</label><input type="number" required value={newMeal.calories} onChange={(e) => setNewMeal({...newMeal, calories: sanitizeNumberInput(e.target.value, newMeal.calories)})} onBlur={(e) => setNewMeal({...newMeal, calories: normalizeNumberOnBlur(e.target.value, false)})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', outline: 'none' }} /></div>
                ...
                <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', background: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(4px)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border-premium)', borderRadius: '20px', padding: '30px', width: '420px', maxWidth: '90%', boxShadow: 'var(--premium-shadow)' }}>
                        ...
                        <form onSubmit={handleSaveProfile} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            <div style={{ display: 'flex', gap: '12px' }}>
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Current Weight (kg)</label>
                                    <input type="number" step="0.1" value={tempProfile.currentWeight} onChange={(e) => setTempProfile({...tempProfile, currentWeight: sanitizeNumberInput(e.target.value, tempProfile.currentWeight)})} onBlur={(e) => setTempProfile({...tempProfile, currentWeight: normalizeNumberOnBlur(e.target.value, true)})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none' }} />
                                </div>
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Target Weight (kg)</label>
                                    <input type="number" step="0.1" value={tempProfile.targetWeight} onChange={(e) => setTempProfile({...tempProfile, targetWeight: sanitizeNumberInput(e.target.value, tempProfile.targetWeight)})} onBlur={(e) => setTempProfile({...tempProfile, targetWeight: normalizeNumberOnBlur(e.target.value, true)})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none' }} />
                                </div>
                            </div>
                            <div style={{ display: 'flex', gap: '12px' }}>
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Daily Calories (kcal)</label>
                                    <input type="number" required value={tempProfile.dailyCalories} onChange={(e) => setTempProfile({...tempProfile, dailyCalories: sanitizeNumberInput(e.target.value, tempProfile.dailyCalories)})} onBlur={(e) => setTempProfile({...tempProfile, dailyCalories: normalizeNumberOnBlur(e.target.value, false)})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none' }} />
                                </div>
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Protein Goal (g)</label>
                                    <input type="number" required value={tempProfile.proteinGoal} onChange={(e) => setTempProfile({...tempProfile, proteinGoal: sanitizeNumberInput(e.target.value, tempProfile.proteinGoal)})} onBlur={(e) => setTempProfile({...tempProfile, proteinGoal: normalizeNumberOnBlur(e.target.value, false)})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none' }} />
                                </div>
                            </div>
                            <div style={{ display: 'flex', gap: '12px' }}>
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Carbs Goal (g)</label>
                                    <input type="number" value={tempProfile.carbsGoal} onChange={(e) => setTempProfile({...tempProfile, carbsGoal: sanitizeNumberInput(e.target.value, tempProfile.carbsGoal)})} onBlur={(e) => setTempProfile({...tempProfile, carbsGoal: normalizeNumberOnBlur(e.target.value, false)})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none' }} />
                                </div>
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Fat Goal (g)</label>
                                    <input type="number" value={tempProfile.fatGoal} onChange={(e) => setTempProfile({...tempProfile, fatGoal: sanitizeNumberInput(e.target.value, tempProfile.fatGoal)})} onBlur={(e) => setTempProfile({...tempProfile, fatGoal: normalizeNumberOnBlur(e.target.value, false)})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none' }} />
                                </div>
                            </div>
                            <div style={{ display: 'flex', gap: '12px' }}>
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Water Goal (L)</label>
                                ...
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Meals Per Day</label>
                                    <input type="number" required value={tempProfile.mealsPerDay} onChange={(e) => setTempProfile({...tempProfile, mealsPerDay: sanitizeNumberInput(e.target.value, tempProfile.mealsPerDay)})} onBlur={(e) => setTempProfile({...tempProfile, mealsPerDay: normalizeNumberOnBlur(e.target.value, false)})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none' }} />
                                </div>
                            </div>
                            <div>
                                <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Primary Goal</label>
                                <select value={tempProfile.goal} onChange={(e) => setTempProfile({...tempProfile, goal: e.target.value})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none', cursor: 'pointer' }}>
                ...
                <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', background: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(4px)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border-premium)', borderRadius: '20px', padding: '30px', width: '420px', maxWidth: '90%', boxShadow: 'var(--premium-shadow)' }}>
                        ...
                        <form onSubmit={handleAddFood} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            <div>
                                <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Food Name</label>
                                <input type="text" required autoFocus value={newFood.name} onChange={(e) => setNewFood({...newFood, name: e.target.value})} placeholder="e.g. Greek Yogurt" style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none' }} />
                            </div>
                            <div style={{ display: 'flex', gap: '12px' }}>
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Category</label>
                                    <select value={newFood.category} onChange={(e) => setNewFood({...newFood, category: e.target.value})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none', cursor: 'pointer' }}>
                                ...
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Serving Size</label>
                                    <input type="text" required value={newFood.serving} onChange={(e) => setNewFood({...newFood, serving: e.target.value})} placeholder="100 g" style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none' }} />
                                </div>
                            </div>
                            <div style={{ display: 'flex', gap: '12px' }}>
                                <div style={{ flex: 1, minWidth: 0 }}><label style={{ display: 'block', fontSize: '12px', fontWeight: '600', color: 'var(--text-muted)', marginBottom: '6px' }}>Calories</label><input type="number" required value={newFood.calories} onChange={(e) => setNewFood({...newFood, calories: sanitizeNumberInput(e.target.value, newFood.calories)})} style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-premium)', background: 'var(--widget-bg)', color: 'var(--text-primary)', fontSize: '14px', outline: 'none' }} /></div>
